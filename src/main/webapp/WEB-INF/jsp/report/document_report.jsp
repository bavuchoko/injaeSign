...
<%@ include file="../header.jsp" %>
	...
	<script>
		function getUserListByDepartmentCode(name){
	         <% HttpSession num = request.getSession();%>
	         var self = '<%=session.getAttribute("userName")%>';
			 $.ajax({
				type:"post",
				url:"/getcrew",
				data:{department_name:name, self:self},
		...
		<div id="righter">
		<form method="post" name="documentFRM" enctype="multipart/form-data" >
		<input type="hidden" name="d_num" value="${document_number}">
		<input type="hidden" name="grade" value="${userGrade}">
			<div class="document">
			
				<div class="col-md-8">
					<div class="confirm_btn">
						<input type="button" class="sangsin" value="상신">

						<input type="button" value="결재선" id="people_icon"/>
					</div>
					...
					<section>		
						...
						<div class="col-md-6">
							...
							<tbody class="signlines">
								<tr>
									<td>기안</td>
									<td><div class="sign"><img src=""></div></td>
									<td>&nbsp;O&nbsp;O&nbsp;O&nbsp;</td>
						...
						<div class="col-md-12">
							...
							<table class="docu_info">
								...
								<tbody>
									<tr>
										<th>작성자</th>
										<td>
											<input type="text" value="${uvo.name }" readonly>
											<input type="hidden" value="${uvo.s_num }" name="s_num">
										</td>
										
										<th>작성부서</th>
										<td>
											<input type="text" name="department_name" value="${uvo.department_name }" readonly>
										</td>
										
										<th>문서타입</th>
										<td>
											<input type="text" name="d_code" value="${contractType }" readonly>
										</td>
									</tr>
								</tbody>
							</table>
							...
							<table class="docu_info">
								...
								<tbody>
									<tr>
										<th>첨부파일</th>
										<td><input type="file" name="qqqq"></td>
									</tr>
								</tbody>
							</table>
				...
				<div id="orgt_body">
					<div id="orgt_body_top">
						...
						<div id="orgt_body_top_righter">
							...
							<div id="dep">
								<div id="dep_header">
									<input type="button" class="deporgtbtn" value="부서">
								</div>
								<div id="dep_body">
							...
							<div id="crew">	
								<div id="crew_header">
									<input type="button" class="deporgtbtn" value="소속원">
								</div>
								<div id="crew_body">
									<c:forEach var="dep" items="${d_list}">
		...
		$(function (){
			...
			$(".send_checked_list").on("click", function(e){
				...
				for(var i=0; i<arr2.length; i++){
					...
					html += "<td><input type='hidden' name='s_nums' value='"+arr[i]+"'></td>"
					html += "</tr>"
