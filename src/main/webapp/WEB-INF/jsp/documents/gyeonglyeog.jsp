...
<body>
    <article class="Collection_of_certificate_of_experience">
        
        <div class="text-center mb-30">
            <h1 class="con-title">경력 증명서</h1>
        ...
        <div>
            <table border="1px solid #dbdbdb">
                ...
                <tr>
                    ...
                    <td width="34%">
                        <input type="text" class="text-w100 border-outline-none" style="text-align: right; border-bottom: 1px solid #dbdbdb;">&nbsp;&nbsp;-&nbsp;
                        <input type="text" style="border-bottom: 1px solid #dbdbdb;" class="text-w100 border-outline-none"></td>
                </tr>
