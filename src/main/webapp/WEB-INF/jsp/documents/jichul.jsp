...
<body>
    <article class="Collection_of_expenditure_resolution">
        
        <div class="text-center mb-30">
            <h1 class="con-title">지출 결의서</h1>
        ...
        <div>
            <table border="1px solid #dbdbdb">
                ...
                <tr>
                    <th colspan="2" rowspan="5">지출내역</th>
				...
				<tr>
                    <td style="text-align: left;"><input type="text" class="border-outline-none"></td>
                    <td style="text-align: left;"><input type="text" class="border-outline-none"></td>
                    <td style="text-align: left;"><input type="text" class="border-outline-none"></td>
                </tr>
