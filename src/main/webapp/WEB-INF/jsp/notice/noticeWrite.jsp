		...
		<header class="LocalHeader">
            ...
            <div class="container">
                <section id="noticeWrite">
                    ...
                    <form action="noticeWritepro" method="POST" enctype="multipart/form-data" name="form">
                        <table>
                            <tr>
                                <th>제목</th>
                                <td><input type="text" name="title" class="noticeWriteTitle input--text" value="" required></td>
                            </tr>
                            <tr>
                                <th>내용</th>
                                <td><textarea name="content" id="content" class="input--text content_notice_write" required></textarea></td>
                            </tr>
                            <tr>
                                <th>파일 첨부</th>
                        ...
                        <div class="noticeView_btn text-center">
